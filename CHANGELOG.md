...
### Security
- Upgrade Rails to `v5.2.4.3` to resolve [CVE-2020-8164](https://groups.google.com/forum/#!topic/rubyonrails-security/f6ioe4sdpbY).
- Use a new base image ruby-fips-base-image-ubuntu and ruby-fips-base-image-phusion
